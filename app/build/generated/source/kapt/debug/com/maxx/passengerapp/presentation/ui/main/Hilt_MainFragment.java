...
public abstract class Hilt_MainFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_MainFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((MainFragment_GeneratedInjector) generatedComponent()).injectMainFragment(UnsafeCasts.<MainFragment>unsafeCast(this));
  }
