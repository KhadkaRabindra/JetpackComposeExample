...
public abstract class Hilt_DetailFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_DetailFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((DetailFragment_GeneratedInjector) generatedComponent()).injectDetailFragment(UnsafeCasts.<DetailFragment>unsafeCast(this));
  }
